...
class BaseOptions(Base):
    def initialize(self):
        ...
        # for uhd
        self.parser.add_argument('--dataroot', required=True, help='path to train_images')
        self.parser.add_argument('--uhd', default='4k', type=str, help='4k or 8k')
        ...
        self.parser.add_argument('--ctest', default='0', type=str, help='continue test 0,1')
