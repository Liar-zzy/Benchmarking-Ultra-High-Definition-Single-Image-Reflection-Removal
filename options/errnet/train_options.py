...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--nEpochs', '-n', type=int, default=100, help='# of epochs to run')
        ...
        self.parser.add_argument('--fineSize', type=str, default='256,256', help='then crop to this size')
